 ...
 *     }
 */
Ext.define('Ext.ux.tree.plugin.TreeViewDragDrop1', {
    extend: 'Ext.AbstractPlugin',
    alias: 'plugin.treeviewdragdrop1',

    uses: [
        'Ext.ux.tree.ViewDragZone',
        'Ext.ux.tree.ViewDropZone'
    ],
    ...
    onViewRender : function(view) {
        ...
        if (me.enableDrag) {
            ...
            me.dragZone = new Ext.ux.tree.ViewDragZone({
                view: view,
        ...
        if (me.enableDrop) {
            me.dropZone = new Ext.ux.tree.ViewDropZone({
                view: view,
